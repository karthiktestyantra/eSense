...
it('EL-756/ES756-01  To validate user is able to  view text book under Topschool library.', function () {
  ...
  it("Validate teacher is able to send a email to user", function () {
    cy.wait(1000);
    adminpages.sendbutton().should("be.visible").eq(0).click();
    adminpages.sendtouser().should("be.visible").eq(0).click();
    cy.wait(5000);
  ...
  it("Validate teacher is able to send a email to admin", function () {
    cy.wait(1000);
    adminpages.sendbutton().should("be.visible").eq(0).click();
    adminpages.sendtoadmin().should("be.visible").eq(0).click();
    cy.wait(5000);
