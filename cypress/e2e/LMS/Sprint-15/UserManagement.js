...
import MainAdminUserManagementPage from "../../../support/pageObjects/LMS-2/MainAdminUserManagementPage";
...
describe("Verify User Management Page functionalities/Sprint-15", function () {
  ...
  beforeEach(function () {
    ...
    cy.fixture("LMS/mainAdminUserManagementPageCredentials").then(function (userManageCredentials) {
