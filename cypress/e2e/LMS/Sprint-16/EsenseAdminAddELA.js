import MainAdminAddELAPage from "../../../support/pageObjects/LMS-2/MainAdminAddELAPage";
...
describe("Verify Esense Admin Main add ELA functionalities", function () {
    ...
    beforeEach(function () {
        cy.fixture('LMS/mainAdminELACredentials').then(function (esenseAdminAddELAData) {
