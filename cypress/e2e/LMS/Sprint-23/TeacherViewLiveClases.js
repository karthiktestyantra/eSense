...
describe("Verify Teacher LeaveRequest Functionality - Sprint 22(EL-6656,EL-6657)", function () {
    ...
    it('/EL-6463/ES6463-04 To validate the system display as " current" status when systems date is matching with current time.', function () {
        ...
        teacherLiveClassPage.getLastDateInCalendarPopup().contains(Number(sysDate)+1).click()
        ...
        teacherViewLiveClassesPage.getTeacherLiveclassesDeletePopupBtn().click()
