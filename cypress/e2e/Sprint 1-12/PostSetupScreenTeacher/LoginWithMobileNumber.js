...
import LoginWithPhoneNumberPage from "../../../support/pageObjects2/LoginWithPhoneNumberPage";
import EnterOTPPage from "../../../support/pageObjects2/EnterOTPPage";
...
describe("Verify Login With Mobile number Functionalities", function () {
  beforeEach(function () {
    cy.fixture("loginWithMobileNumber").then(function (mobileData) {
      this.mobileData = mobileData;
    });

    cy.fixture("mobileNumber").then(function (mobileNumberData) {
