...
// import RequestChange from "../../../support/pageObjects2/RequestChange";
...
//   beforeEach(function () {
//     cy.fixture("presetupTeacherLoginDetails").then(function (validLoginData) {
//       this.validLoginData = validLoginData;
//     });
//     cy.fixture("walkthroughPageTitles").then(function (walkthroughTitles) {
//       this.walkthroughTitles = walkthroughTitles;
//     });

//     cy.fixture("requestChange").then(function (requestChangeData) {
