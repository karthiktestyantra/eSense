...
import MainAdminOrganisationManagementPage from "../../support/pageObjects/MainAdminOrganisationManagementPage";
...
describe("Verify Organisation Page functionalities", function () {
  ...
  beforeEach(function (){
    cy.fixture("mainAdminOrganisationManagementCredentials").then(function(OrgCredentials){
