import TeacherELAPage2 from "../../support/PageObjects/TeacherELAPage2";
...
describe("Verify Teacher ELA Page functionalities", function () {
    before(function () {
        ...
        cy.fixture('TeacherLoginCredentials').then(function (validTeacherLoginData) {
            cy.TeacherPostSetupLogin(validTeacherLoginData.user3, validTeacherLoginData.password)
        })
    })

    beforeEach(function () {
        cy.fixture('TeacherELACredentials').then(function (teacherELA) {
