...
import Teacher360ReportPage from "../../support/pageObjects/Teacher360ReportPage";
...
describe("Verify Domain Mapping functionalities", function () {
  ...
  beforeEach(function (){
    cy.fixture("TeacherELACredentials").then(function(report){
      this.report = report;
    })
    cy.fixture("Admin360report").then(function(repo){
      this.repo = repo;
    })
  })
