...
import AdminQuickLinksPage from "../../support/PageObjects/AdminQuickLinksPage";
...
describe("Verify Esense Teacher Login Page functionalities", function () {
    ...
    beforeEach(function (){  
        cy.fixture('AdminQuickLink').then(function(adminQuickLink){
   ...
   it("To validate that user is able to create the timetable by clicking on Generate Timetable button in post-setup if the timetable is not configured during pre-setup/EL-5163/ES5163_01",function () {
      ...
      adminQuickLinksPage.getViewTimeTableStartTime().eq(0).click()
      ...
      adminQuickLinksPage.getViewTimeTableStartTime().eq(0).click()
      cy.wait(1000)
      adminQuickLinksPage.getViewTimeTableEndTime().eq(1).click()
...
//    })
   ...
   it("To validate that user is able to select the school Start Time from School Start Time clockz/EL-5163/ES5163_10",function () {
    cy.get('[placeholder="h:mm (a|p)m"]').eq(0).should('be.visible').click()
   ...
   it("To validate that user is able to select the school Ending Time from School Ending Time clock/EL-5163/ES5163_12",function () {
    cy.wait(1000)
      cy.get('[placeholder="h:mm (a|p)m"]').eq(1).should('be.visible').click()
