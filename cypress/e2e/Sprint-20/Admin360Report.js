...
// import Admin360ReportPage from "../../support/pageObjects/Admin360ReportPage";
...
//   })
//   beforeEach(function (){
//     cy.fixture("Admin360Report").then(function(report){
//       this.report = report;
//     })
//   })

//  //pre-condition
//  it("Validate whether report page is displayed with 'Search Box', 'Check Box', 'ROLL NUMBER', 'FIRST NAME', 'LAST NAME', 'LAST ACTIVE', 'REPORTS'",function(){
//     home.getReportLnk().click({force:true})
//     report.get360ReportLnk().click()
//     report.get360ReportContents().should('contain.text',"ROLL NO").and('contain.text',"LAST NAME").
...
//  it("Validate whether list of students are displayed as per drop down selection/EL-4124/ELS4124_3",function(){
//   report.getFrstNameLst().should('contain.text',this.report.Student1FrstName)
//  })
...
//  it("Validate user selects the check box in the 1st column all the students checkbox are selected except the student those have flag raised in front of their name",function(){
...
//  it("Validate user clicks on 'Generate' button")
// })